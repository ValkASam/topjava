...
abstract public class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    public void testSave() throws Exception {
        ...
        set.addAll(Arrays.asList(Role.ROLE_USER, Role.ROLE_ADMIN));
        TestUser tu = new TestUser(null, "New", "new@gmail.com", "newPass", 1555, false, set);
    ...
    public void testUpdate() throws Exception {
        ...
        Set<Role> roles = new HashSet<Role>((Collection)Arrays.asList(updated.getRoles().toArray()));
